    ...
    const CustomCalendar = {
        ...
        replaceDataInput() {
            ...
            const calendarHTML = `
                ...
                <!-- Keep original input visible as fallback -->
                <input type="date" id="booking-date" name="booking-date" required
                       style="width: 100%; height: 50px; padding: 0.75rem; border: 2px solid #e2e8f0; border-radius: 8px; font-size: 1rem; box-sizing: border-box; margin-top: 1rem;"
                       min="" max=""
                       aria-label="Select date using native date picker (fallback option)">
            ...
            // Hide original input and add calendar after it
            const originalInput = document.getElementById('booking-date');
            if (originalInput) {
                originalInput.style.display = 'none';
                originalInput.insertAdjacentHTML('afterend', calendarHTML);
            } else {
